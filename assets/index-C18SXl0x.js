import{a as u,H as x}from"./header-wf8HbVZh.js";import{H as T,C as q,a as C,W,S as k}from"./swiper-u5zl1HCs.js";import{g as _,b as h,c as m,q as w,w as y}from"./index.esm2017-CVpEnNBY.js";import{A as H}from"./allImportFile-6fFLMoey.js";import"./air-datepicker-yKkfEXOD.js";const g=document.querySelector(".main-company__swiper-wrapper");class P{app;db;productsArray;constructor(){this.app=u,this.db=_(this.app),this.productsArray=[]}async loadCards(){(await h(m(this.db,"hotels"))).forEach(r=>{const s=r.data();this.productsArray.push(s)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(r=>{const s=r,{name:a,price:e,img:c,date:d}=s;if(c&&Array.isArray(c)&&c.length>0){const{url:p,urlWebp:o}=c[0];let i=`
