import{c as C,_ as Ee,d as ve,e as ke,f as Ue,C as Le,r as W,h as Oe,S as Ie,F as Pe,a as Se,g as I,o as oe,H as Ne}from"./header-wf8HbVZh.js";import{g as xe,a as X,c as K,d as Ce,u as De}from"./index.esm2017-1n6GMZbt.js";import{a as Be}from"./justValidate-ywqcVI2V.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(t,e,n){let s=1,r=null,o=null,i=!1,c=0;function a(){return c===2}let u=!1;function f(...b){u||(u=!0,e.apply(null,b))}function g(b){r=setTimeout(()=>{r=null,t(m,a())},b)}function p(){o&&clearTimeout(o)}function m(b,...v){if(u){p();return}if(b){p(),f.call(null,b,...v);return}if(a()||i){p(),f.call(null,b,...v);return}s<64&&(s*=2);let y;c===1?(c=2,y=0):y=(s+Math.random())*1e3,g(y)}let _=!1;function E(b){_||(_=!0,p(),!u&&(r!==null?(b||(c=2),clearTimeout(r),g(0)):b||(c=1)))}return g(0),o=setTimeout(()=>{i=!0,E(!0)},n),E}function nt(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class it{constructor(e,n,s,r,o,i,c,a,u,f,g,p=!0){this.url_=e,this.method_=n,this.headers_=s,this.body_=r,this.successCodes_=o,this.additionalRetryCodes_=i,this.callback_=c,this.errorCallback_=a,this.timeout_=u,this.progressCallback_=f,this.connectionFactory_=g,this.retry=p,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((m,_)=>{this.resolve_=m,this.reject_=_,this.start_()})}start_(){const e=(s,r)=>{if(r){s(!1,new N(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const i=c=>{const a=c.loaded,u=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(a,u)};this.progressCallback_!==null&&o.addUploadProgressListener(i),o.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(i),this.pendingConnection_=null;const c=o.getErrorCode()===U.NO_ERROR,a=o.getStatus();if(!c||ot(a,this.additionalRetryCodes_)&&this.retry){const f=o.getErrorCode()===U.ABORT;s(!1,new N(!1,null,f));return}const u=this.successCodes_.indexOf(a)!==-1;s(!0,new N(u,o))})},n=(s,r)=>{const o=this.resolve_,i=this.reject_,c=r.connection;if(r.wasSuccessCode)try{const a=this.callback_(c,c.getResponse());st(a)?o(a):o()}catch(a){i(a)}else if(c!==null){const a=q();a.serverResponse=c.getErrorText(),this.errorCallback_?i(this.errorCallback_(c,a)):i(a)}else if(r.canceled){const a=this.appDelete_?ce():We();i(a)}else{const a=Ve();i(a)}};this.canceled_?n(!1,new N(!1,null,!0)):this.backoffId_=tt(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&nt(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class N{constructor(e,n,s){this.wasSuccessCode=e,this.connection=n,this.canceled=!!s}}function at(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function ct(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function ut(t,e){e&&(t["X-Firebase-GMPID"]=e)}function lt(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function dt(t,e,n,s,r,o,i=!0){const c=ue(t.urlParams),a=t.url+c,u=Object.assign({},t.headers);return ut(u,e),at(u,n),ct(u,o),lt(u,s),new it(a,t.method,u,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,r,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function At(t,e){return e}class w{constructor(e,n,s,r){this.server=e,this.local=n||e,this.writable=!!s,this.xform=r||At}}let x=null;function Et(t){return!H(t)||t.length<2?t:pe(t)}function _e(){if(x)return x;const t=[];t.push(new w("bucket")),t.push(new w("generation")),t.push(new w("metageneration")),t.push(new w("name","fullPath",!0));function e(o,i){return Et(i)}const n=new w("name");n.xform=e,t.push(n);function s(o,i){return i!==void 0?Number(i):i}const r=new w("size");return r.xform=s,t.push(r),t.push(new w("timeCreated")),t.push(new w("updated")),t.push(new w("md5Hash",null,!0)),t.push(new w("cacheControl",null,!0)),t.push(new w("contentDisposition",null,!0)),t.push(new w("contentEncoding",null,!0)),t.push(new w("contentLanguage",null,!0)),t.push(new w("contentType",null,!0)),t.push(new w("metadata","customMetadata",!0)),x=t,x}function vt(t,e){function n(){const s=t.bucket,r=t.fullPath,o=new R(s,r);return e._makeStorageReference(o)}Object.defineProperty(t,"ref",{get:n})}function kt(t,e,n){const s={};s.type="file";const r=n.length;for(let o=0;o<r;o++){const i=n[o];s[i.local]=i.xform(s,e[i.server])}return vt(s,t),s}function ge(t,e,n){const s=fe(e);return s===null?null:kt(t,s,n)}function Ut(t,e,n,s){const r=fe(e);if(r===null||!H(r.downloadTokens))return null;const o=r.downloadTokens;if(o.length===0)return null;const i=encodeURIComponent;return o.split(",").map(u=>{const f=t.bucket,g=t.fullPath,p="/b/"+i(f)+"/o/"+i(g),m=z(p,n,s),_=ue({alt:"media",token:u});return m+_})[0]}function Lt(t,e){const n={},s=e.length;for(let r=0;r<s;r++){const o=e[r];o.writable&&(n[o.server]=t[o.local])}return JSON.stringify(n)}class me{constructor(e,n,s,r){this.url=e,this.method=n,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function be(t){if(!t)throw q()}function Ot(t,e){function n(s,r){const o=ge(t,r,e);return be(o!==null),o}return n}function It(t,e){function n(s,r){const o=ge(t,r,e);return be(o!==null),Ut(o,r,t.host,t._protocol)}return n}function we(t){function e(n,s){let r;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?r=je():r=He():n.getStatus()===402?r=qe(t.bucket):n.getStatus()===403?r=ze(t.path):r=s,r.status=n.getStatus(),r.serverResponse=s.serverResponse,r}return e}function Pt(t){const e=we(t);function n(s,r){let o=e(s,r);return s.getStatus()===404&&(o=$e(t.path)),o.serverResponse=r.serverResponse,o}return n}function St(t,e,n){const s=e.fullServerUrl(),r=z(s,t.host,t._protocol),o="GET",i=t.maxOperationRetryTime,c=new me(r,o,It(t,n),i);return c.errorHandler=Pt(e),c}function Nt(t,e){return t&&t.contentType||e&&e.type()||"application/octet-stream"}function xt(t,e,n){const s=Object.assign({},n);return s.fullPath=t.path,s.size=e.size(),s.contentType||(s.contentType=Nt(null,e)),s}function Ct(t,e,n,s,r){const o=e.bucketOnlyServerUrl(),i={"X-Goog-Upload-Protocol":"multipart"};function c(){let y="";for(let l=0;l<2;l++)y=y+Math.random().toString().slice(2);return y}const a=c();i["Content-Type"]="multipart/related; boundary="+a;const u=xt(e,s,r),f=Lt(u,n),g="--"+a+`\r
 ...
 */const Te="storage";function Vt(t,e,n){return t=C(t),Mt(t,e,n)}function Wt(t){return t=C(t),Ft(t)}function Xt(t,e){return t=C(t),jt(t,e)}function Kt(t=ke(),e){t=C(t);const s=Ee(t,Te).getImmediate({identifier:e}),r=ve("storage");return r&&Gt(s,...r),s}function Gt(t,e,n,s={}){zt(t,e,n,s)}function Yt(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new V(n,s,r,e,Ie)}function Zt(){Ue(new Le(Te,Yt,"PUBLIC").setMultipleInstances(!0)),W(J,Q,""),W(J,Q,"esm2017")}Zt();const Jt=Kt();async function Qt(t){try{const e=Xt(Jt,"images/"+t.name),n=await Vt(e,t);return console.log(n),await Wt(e)}catch(e){throw console.error("Failed to upload image to Firebase Storage:",e),e}}class en{currentPage;usersLength;constructor(e){this.currentPage=1,this.usersLength=e,this.init()}init(){this.pagination()}pagination(){const e=this,n=document.getElementById("account-button-prev"),s=document.getElementById("account-button-next"),r=document.getElementById("account-button-prev-mob"),o=document.getElementById("account-button-next-mob"),i=document.getElementById("current-page"),c=document.getElementById("all-pages"),a=document.getElementById("current-page-mob"),u=document.getElementById("all-pages-mob"),f=Math.ceil(this.usersLength/9);c&&(c.textContent=String(f)),u&&(u.textContent=String(f)),n?.addEventListener("click",()=>{g()}),r?.addEventListener("click",()=>{g()}),s?.addEventListener("click",()=>{p()}),o?.addEventListener("click",()=>{p()});function g(){e.currentPage>1&&(e.currentPage--,_(),m())}function p(){e.currentPage<f&&(e.currentPage++,_(),m())}function m(){const E=e.currentPage,b=document.querySelectorAll(".order"),v=document.querySelectorAll(".account-mobile__table-wrapper"),T=e.currentPage*9-1,y=T-8;v.forEach(l=>{+l.id>=y&&+l.id<=T?l.classList.add("account-mobile__table-wrapper_active"):l.classList.remove("account-mobile__table-wrapper_active")}),b.forEach(l=>{+l.id>=y&&+l.id<=T?l.classList.add("order_active"):l.classList.remove("order_active")}),E===1?(n?.classList.remove("account__table-bottom-button_active"),r?.classList.remove("account__table-bottom-button_active")):(n?.classList.add("account__table-bottom-button_active"),r?.classList.add("account__table-bottom-button_active")),E===f?(s?.classList.remove("account__table-bottom-button_active"),o?.classList.remove("account__table-bottom-button_active")):(s?.classList.add("account__table-bottom-button_active"),o?.classList.add("account__table-bottom-button_active"))}function _(){i&&(i.innerHTML=String(e.currentPage)),a&&(a.innerHTML=String(e.currentPage))}m()}}const ee=document.querySelector(".account__order"),te=document.querySelector(".account__table-bottom-left"),ne=document.querySelector(".account__table-bottom-left-mobile"),se=document.querySelector(".account-mobile__table"),re=document.querySelector(".account__left");class tn{app;db;usersArray;currentUser;constructor(){this.app=Se,this.db=xe(this.app),this.usersArray=[],this.currentUser=null,this.initAuth(),this.renderAccountLeft()}initAuth(){const e=I();oe(e,n=>{this.currentUser=n,n?this.loadCards():(this.usersArray=[],this.renderUsers())})}exitAccount(){I().signOut().then(()=>{console.log("Пользователь вышел из аккаунта")}).catch(n=>{console.error("Ошибка при выходе из аккаунта:",n)})}async renderAccountLeft(){const e=await X(K(this.db,"users"));if(!this.currentUser)return;const n=this.currentUser.email;e.forEach(r=>{const o=r.data();if(o.email===n){const{name:i,photo:c}=o;let a=`
        ...
        `;re&&re.insertAdjacentHTML("beforeend",a)}}),this.settings(),document.querySelector(".account__left-exit")?.addEventListener("click",r=>{r.preventDefault(),this.exitAccount()})}settings(){const e=document.querySelector(".account__left-settings"),n=document.querySelector(".account__left-order"),s=document.querySelector(".account__right"),r=document.querySelector(".account__settings");document.querySelector(".account__left-wrapper")?.addEventListener("click",i=>{const c=i.target;if(c){const a=c.textContent;a&&a.includes("Настройки")?(e?.classList.add("active"),n?.classList.remove("active"),s?.classList.add("active"),r?.classList.remove("active")):a&&a.includes("Мои заказы")&&(n?.classList.add("active"),e?.classList.remove("active"),s?.classList.remove("active"),r?.classList.add("active"))}})}isChangeInput(){const e=document.querySelector(".account__settings-input input"),n=document.querySelector(".account__settings-button");e.value===""&&(n.disabled=!0),e?.addEventListener("input",()=>{e.value===""||e.value.length<3||e.value.length>20?n.disabled=!0:n.disabled=!1})}async updateUserProfile(e,n){try{if(!this.currentUser)throw new Error("No user is currently signed in.");const s=Ce(this.db,"users",this.currentUser.uid);await De(s,{name:e,photo:n}),console.log("User profile updated successfully!"),window.location.href="account.html"}catch(s){console.error("Failed to update user profile:",s)}}async getFormData(){const e=document.querySelector("#settingsForm");e?.addEventListener("submit",async n=>{n.preventDefault();const s=new FormData(e),r=s.get("name"),o=s.get("photo");let i;if(o&&o.size>0)try{i=await Qt(o)}catch(c){console.error("Failed to upload image to Firebase Storage:",c)}else i=document.querySelector(".account__left-photo img").src;await this.updateUserProfile(r,i)})}async loadCards(){if(!this.currentUser)return;const e=this.currentUser.email;(await X(K(this.db,"users"))).forEach(s=>{s.data().orders.forEach(o=>{o.email===e&&this.usersArray.push(o)})}),this.renderUsers(),new en(this.usersArray.length)}renderUsers(){this.usersArray.forEach((r,o)=>{const i=r,{date:c,email:a,idOrder:u,payStatus:f,price:g}=i;let p=`
        <td>${u}</td>
        <td>${g}</td>
        `;a.length<23?p+=`
                <td>${a}</td>
