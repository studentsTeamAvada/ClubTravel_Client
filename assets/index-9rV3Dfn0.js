import{a as u,H as T}from"./header-Jv2ZkStG.js";import{H as q,C as x,a as W,W as C,S as k}from"./swiper-LJiYZK07.js";import{g as _,a as h,c as m,q as w,w as v}from"./index.esm2017-wBt5Meyf.js";import{A as H}from"./allImportFile-VED0IQun.js";import"./air-datepicker-F0XLJdot.js";const g=document.querySelector(".main-company__swiper-wrapper");class P{app;db;productsArray;constructor(){this.app=u,this.db=_(this.app),this.productsArray=[]}async loadCards(){(await h(m(this.db,"hotels"))).forEach(e=>{const r=e.data();this.productsArray.push(r)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const r=e,{name:a,price:s,img:c,date:p}=r;if(c&&Array.isArray(c)&&c.length>0){const{url:d,urlWebp:i}=c[0];let o=`
