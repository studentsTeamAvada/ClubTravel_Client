 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=new Map,wr=new Map;function dc(i,e){try{i.container.addComponent(e)}catch(r){at.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,r)}}function Gt(i){const e=i.name;if(wr.has(e))return at.debug(`There were multiple attempts to register component ${e}.`),!1;wr.set(e,i);for(const r of Cn.values())dc(r,i);return!0}function is(i,e){const r=i.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),i.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ec(i){Gt(new St("platform-logger",e=>new ja(e),"PRIVATE")),Gt(new St("heartbeat",e=>new wc(e),"PRIVATE")),It(br,ki,i),It(br,ki,"esm2017"),It("fire-js","")}Ec("");var Cc="firebase",Sc="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dr(i,e){return nn(i,"POST","/v1/accounts:signInWithPassword",lt(i,e))}async function cu(i,e){return ft(i,"POST","/v1/accounts:sendOobCode",lt(i,e))}async function hr(i,e){return cu(i,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pr(i,e){return nn(i,"POST","/v1/accounts:signUp",lt(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ml(i,e,r){var a;const f=Ye(i),h={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};if(!((a=f._getRecaptchaConfig())===null||a===void 0)&&a.emailPasswordEnabled){const v=await At(f,h,"getOobCode",!0);r&&gr(f,v,r),await hr(f,v)}else r&&gr(f,h,r),await hr(f,h).catch(async v=>{if(v.code==="auth/missing-recaptcha-token"){console.log("Password resets are protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the password reset flow.");const S=await At(f,h,"getOobCode",!0);r&&gr(f,S,r),await hr(f,S)}else return Promise.reject(v)})}async function Ul(i,e,r){var a;const f=Ye(i),h={returnSecureToken:!0,email:e,password:r,clientType:"CLIENT_TYPE_WEB"};let v;if(!((a=f._getRecaptchaConfig())===null||a===void 0)&&a.emailPasswordEnabled){const x=await At(f,h,"signUpPassword");v=pr(f,x)}else v=pr(f,h).catch(async x=>{if(x.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const q=await At(f,h,"signUpPassword");return pr(f,q)}else return Promise.reject(x)});const S=await v.catch(x=>Promise.reject(x)),A=await ut._fromIdTokenResponse(f,"signIn",S);return await f._updateCurrentUser(A.user),A}function jl(i,e,r){return mu(Xe(i),kt.credential(e,r))}function yu(i,e,r,a){return Xe(i).onIdTokenChanged(e,r,a)}function vu(i,e,r){return Xe(i).beforeAuthStateChanged(e,r)}function bu(i,e,r,a){return Xe(i).onAuthStateChanged(e,r,a)}const Rn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
