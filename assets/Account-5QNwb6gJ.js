import"./jquery-eLIhC4UN.js";import{H as l}from"./header-4uj2AVG8.js";import{g as m,b as f,c as A}from"./index.esm2017-rx8I47mm.js";import{a as y}from"./firebase-IW9Y5CYr.js";import{g,o as b}from"./index-e24386e7-jS-Ti_7U.js";import"./index.esm2017-NEpo2ibe.js";import{I as U}from"./isAuthorization-0V39ZNC-.js";const o=document.querySelector(".account__order"),c=document.querySelector(".account__table-bottom-left");class _{app;db;usersArray;currentUser;constructor(){this.app=y,this.db=m(this.app),this.usersArray=[],this.currentUser=null,this.initAuth()}initAuth(){const e=g();b(e,t=>{this.currentUser=t,t?this.loadCards():(this.usersArray=[],this.renderUsers())})}async loadCards(){if(!this.currentUser)return;const e=this.currentUser.email;(await f(A(this.db,"users"))).forEach(a=>{const s=a.data().orders;console.log(s.email),s.email===e&&this.usersArray.push(s)}),this.renderUsers()}renderUsers(){this.usersArray.forEach(a=>{const s=a,{date:d,email:n,idOrder:u,payStatus:p,price:h}=s;let r=`
        <td>${u}</td>
        <td>${h}</td>
        `;n.length<23?r+=`
              <td>${n}</td>
