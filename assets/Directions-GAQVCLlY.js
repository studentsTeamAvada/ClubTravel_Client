import{H as n}from"./header-hiQeVM5C.js";import{g as l,a as _,c as u}from"./index.esm2017-9WYfP4j3.js";import{i as f}from"./index.esm-RQMDg1fI.js";const h={apiKey:"AIzaSyAVwhQr2zeNEAr1FSrD6ygo5dJeLkxjtRk",authDomain:"clubtravel-6eff6.firebaseapp.com",projectId:"clubtravel-6eff6",storageBucket:"clubtravel-6eff6.appspot.com",messagingSenderId:"883499742498",appId:"1:883499742498:web:b0bf6b06d8073d249a217b"},t=document.querySelector(".directions__wrapper");class b{app;db;productsArray;constructor(){this.app=f(h),this.db=l(this.app),this.productsArray=[]}async loadCards(){(await _(u(this.db,"hotels"))).forEach(e=>{const c=e.data();this.productsArray.push(c)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const c=e,{img:s,country:o,region:a}=c;if(s&&Array.isArray(s)&&s.length>0){const{url:d,urlWebp:p}=s[0];let r=`
