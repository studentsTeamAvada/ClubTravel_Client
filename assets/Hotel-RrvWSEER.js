import{$ as d,H as p}from"./header-o5Nvgfqe.js";import{H as u,b as _}from"./swiper-10gZNCD3.js";import"./autoplay-3nwb4p1k.js";class f{fb;constructor(){this.fb=d(".pictures__social-window"),this.fbPluginReload()}fbPluginReload(){window.addEventListener("resize",()=>{})}}class w{dropDown;dropMain;quatityAdults;quatityKids;addBtn;btn;children;tegContainer;error;currentAbdul;currentKids;constructor(e){this.dropDown=d(e).find(".dropdown"),this.dropMain=this.dropDown.find(".dropdown__main"),this.quatityAdults=this.dropDown.find("#adults-quantity"),this.quatityKids=this.dropDown.find("#kids-quantity"),this.addBtn=this.dropDown.find(".dropdown__button-add"),this.error=this.dropDown.find(".dropdown__error"),this.btn=this.dropDown.find(".dropdown__btn"),this.children=this.dropDown.find(".dropdown__children"),this.tegContainer=d(".tour__quantity-tegs"),this.currentAbdul=0,this.currentKids=0,this.init()}init(){this.open(),this.counter(this.dropDown.find(".dropdown__count-one")),this.counter(this.dropDown.find(".dropdown__count-two"),!0),this.removeAgeSelect(1),this.addPeople()}open(){this.btn.on("click",()=>{this.dropDown.toggleClass("dropdown_active")});const e=this;d(document).on("click",function(r){e.dropDown.has(r.target).length==0&&e.dropDown.removeClass("dropdown_active")})}counter(e,r=!1){const t=e.find(".dropdown__count-add"),i=e.find(".dropdown__count-remove"),o=e.find(".dropdown__count-current"),n=this;function s(){let c=+o.text();if(c<9){const l=c+1;o.html(String(l)),r?n.timeout(l,!0):(n.currentAbdul=l,n.error.removeClass("dropdown__error_active-abduls"))}}function h(){let c=+o.text();if(c>0){const l=c-1;o.html(String(l)),r?n.timeout(l,!1):n.currentAbdul=l}}t.on("click",s),i.on("click",h)}addAgeSelect(e){const t=this.dropDown.find(".children__drop").length;for(let i=0;i<e;i++)if(i>t-1){this.children.append(`
