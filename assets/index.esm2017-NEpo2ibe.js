 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tt(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},s=e||"demo-project",r=t.iat||0,o=t.sub||t.user_id;if(!o)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const i=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:r,exp:r+3600,auth_time:r,sub:o,user_id:o,firebase:{sign_in_provider:"custom",identities:{}}},t);return[_(JSON.stringify(n)),_(JSON.stringify(i)),""].join(".")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge="FirebaseError";class b extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=ge,Object.setPrototypeOf(this,b.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Q.prototype.create)}}class Q{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,o=this.errors[e],i=o?be(o,s):"Error",a=`${this.serviceName}: ${i} (${r}).`;return new b(r,a,s)}}function be(t,e){return t.replace(Ee,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const Ee=/\{\$([^}]+)}/g;function Pt(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function O(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const r of n){if(!s.includes(r))return!1;const o=t[r],i=e[r];if(F(o)&&F(i)){if(!O(o,i))return!1}else if(o!==i)return!1}for(const r of s)if(!n.includes(r))return!1;return!0}function F(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ft(t){return t&&t._delegate?t._delegate:t}class v{constructor(e,n,s){this.name=e,this.instanceFactory=n,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class je{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ue(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Ue(t){const e=t.getComponent();return e?.type==="VERSION"}const N="@firebase/app",z="0.9.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p=new Oe("@firebase/app"),Ve="@firebase/app-compat",ze="@firebase/analytics-compat",We="@firebase/analytics",Ge="@firebase/app-check-compat",Je="@firebase/app-check",Ke="@firebase/auth",Ye="@firebase/auth-compat",qe="@firebase/database",Xe="@firebase/database-compat",Qe="@firebase/functions",Ze="@firebase/functions-compat",et="@firebase/installations",tt="@firebase/installations-compat",nt="@firebase/messaging",rt="@firebase/messaging-compat",st="@firebase/performance",ot="@firebase/performance-compat",it="@firebase/remote-config",at="@firebase/remote-config-compat",ct="@firebase/storage",ht="@firebase/storage-compat",lt="@firebase/firestore",dt="@firebase/firestore-compat",ft="firebase",ut="10.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R="[DEFAULT]",pt={[N]:"fire-core",[Ve]:"fire-core-compat",[We]:"fire-analytics",[ze]:"fire-analytics-compat",[Je]:"fire-app-check",[Ge]:"fire-app-check-compat",[Ke]:"fire-auth",[Ye]:"fire-auth-compat",[qe]:"fire-rtdb",[Xe]:"fire-rtdb-compat",[Qe]:"fire-fn",[Ze]:"fire-fn-compat",[et]:"fire-iid",[tt]:"fire-iid-compat",[nt]:"fire-fcm",[rt]:"fire-fcm-compat",[st]:"fire-perf",[ot]:"fire-perf-compat",[it]:"fire-rc",[at]:"fire-rc-compat",[ct]:"fire-gcs",[ht]:"fire-gcs-compat",[lt]:"fire-fst",[dt]:"fire-fst-compat","fire-js":"fire-js",[ft]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new Map,$=new Map;function mt(t,e){try{t.container.addComponent(e)}catch(n){p.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function P(t){const e=t.name;if($.has(e))return p.debug(`There were multiple attempts to register component ${e}.`),!1;$.set(e,t);for(const n of I.values())mt(n,t);return!0}function jt(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=ut;function Et(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:R,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw f.create("bad-app-name",{appName:String(r)});if(n||(n=q()),!n)throw f.create("no-options");const o=I.get(r);if(o){if(O(n,o.options)&&O(s,o.config))return o;throw f.create("duplicate-app",{appName:r})}const i=new we(r);for(const h of $.values())i.addComponent(h);const a=new bt(n,s,i);return I.set(r,a),a}function Vt(t=R){const e=I.get(t);if(!e&&t===R&&q())return Et();if(!e)throw f.create("no-app",{appName:t});return e}function A(t,e,n){var s;let r=(s=pt[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const o=r.match(/\s|\//),i=e.match(/\s|\//);if(o||i){const a=[`Unable to register library "${r}" with version "${e}":`];o&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&i&&a.push("and"),i&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),p.warn(a.join(" "));return}P(new v(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt="firebase-heartbeat-database",_t=1,g="firebase-heartbeat-store";let B=null;function te(){return B||(B=xe(yt,_t,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(g)}}}).catch(t=>{throw f.create("idb-open",{originalErrorMessage:t.message})})),B}async function vt(t){try{return await(await te()).transaction(g).objectStore(g).get(ne(t))}catch(e){if(e instanceof b)p.warn(e.message);else{const n=f.create("idb-get",{originalErrorMessage:e?.message});p.warn(n.message)}}}async function W(t,e){try{const s=(await te()).transaction(g,"readwrite");await s.objectStore(g).put(e,ne(t)),await s.done}catch(n){if(n instanceof b)p.warn(n.message);else{const s=f.create("idb-set",{originalErrorMessage:n?.message});p.warn(s.message)}}}function ne(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function At(t){P(new v("platform-logger",e=>new je(e),"PRIVATE")),P(new v("heartbeat",e=>new wt(e),"PRIVATE")),A(N,z,t),A(N,z,"esm2017"),A("fire-js","")}At("");export{v as C,Q as E,b as F,c as L,Ut as S,P as _,Vt as a,jt as b,Bt as c,Oe as d,Tt as e,Ot as f,Ft as g,Mt as h,Et as i,Rt as j,Nt as k,kt as l,fe as m,X as n,O as o,Lt as p,Ht as q,A as r,xt as s,ae as t,$t as u,Pt as v};
