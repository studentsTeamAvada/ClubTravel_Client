import"./jquery-DgZYk2H_.js";import{H as T}from"./header-ARewE4Ia.js";import{H as q,C as x,a as P,W,S as C}from"./swiper-6MPslvsj.js";import{a as l}from"./firebase-IW9Y5CYr.js";import{g as m,b as _,c as h,q as w,w as v}from"./index.esm2017-rx8I47mm.js";import{P as k}from"./preloader-995_IHTn.js";import{I as H}from"./isAuthorization-0V39ZNC-.js";import"./autoplay-3nwb4p1k.js";import"./index.esm2017-NEpo2ibe.js";import"./index-e24386e7-jS-Ti_7U.js";const g=document.querySelector(".main-company__swiper-wrapper");class E{app;db;productsArray;constructor(){this.app=l,this.db=m(this.app),this.productsArray=[]}async loadCards(){(await _(h(this.db,"hotels"))).forEach(a=>{const s=a.data();this.productsArray.push(s)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(a=>{const s=a,{name:e,price:r,img:c,date:i}=s;if(c&&Array.isArray(c)&&c.length>0){const{url:p,urlWebp:o}=c[0];let n=`
