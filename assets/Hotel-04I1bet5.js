import"./modulepreload-polyfill-9p4a8sJU.js";import{$ as s,H as p}from"./header-msV6j5kN.js";import{H as u,b as _}from"./swiper-10gZNCD3.js";import"./autoplay-3nwb4p1k.js";class f{fb;constructor(){this.fb=s(".pictures__social-window"),this.fbPluginReload()}fbPluginReload(){window.addEventListener("resize",()=>{})}}class w{dropDown;dropMain;quatityAdults;quatityKids;addBtn;btn;children;tegContainer;error;currentAbdul;currentKids;constructor(t){this.dropDown=s(t).find(".dropdown"),this.dropMain=this.dropDown.find(".dropdown__main"),this.quatityAdults=this.dropDown.find("#adults-quantity"),this.quatityKids=this.dropDown.find("#kids-quantity"),this.addBtn=this.dropDown.find(".dropdown__button-add"),this.error=this.dropDown.find(".dropdown__error"),this.btn=this.dropDown.find(".dropdown__btn"),this.children=this.dropDown.find(".dropdown__children"),this.tegContainer=s(".tour__quantity-tegs"),this.currentAbdul=0,this.currentKids=0,this.init()}init(){this.open(),this.counter(this.dropDown.find(".dropdown__count-one")),this.counter(this.dropDown.find(".dropdown__count-two"),!0),this.removeAgeSelect(1),this.addPeople()}open(){this.btn.on("click",()=>{this.dropDown.toggleClass("dropdown_active")});const t=this;s(document).on("click",function(r){t.dropDown.has(r.target).length==0&&t.dropDown.removeClass("dropdown_active")})}counter(t,r=!1){const e=t.find(".dropdown__count-add"),i=t.find(".dropdown__count-remove"),o=t.find(".dropdown__count-current"),n=this;function l(){let c=+o.text();if(c<9){const d=c+1;o.html(String(d)),r?n.timeout(d,!0):(n.currentAbdul=d,n.error.removeClass("dropdown__error_active-abduls"))}}function a(){let c=+o.text();if(c>0){const d=c-1;o.html(String(d)),r?n.timeout(d,!1):n.currentAbdul=d}}e.on("click",l),i.on("click",a)}addAgeSelect(t){const e=this.dropDown.find(".children__drop").length;for(let i=0;i<t;i++)if(i>e-1){this.children.append(`
