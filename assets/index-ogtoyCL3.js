import{a as u,H as T}from"./header-CGHlbq-5.js";import{H as q,C as x,a as P,W,S as C}from"./swiper-3ZbHupTH.js";import{g as _,a as m,c as h,q as w,w as v}from"./index.esm2017-Kikq7U2_.js";import{P as k}from"./preloader-t9H2ZNYp.js";const g=document.querySelector(".main-company__swiper-wrapper");class H{app;db;productsArray;constructor(){this.app=u,this.db=_(this.app),this.productsArray=[]}async loadCards(){(await m(h(this.db,"hotels"))).forEach(a=>{const s=a.data();this.productsArray.push(s)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(a=>{const s=a,{name:e,price:r,img:c,date:i}=s;if(c&&Array.isArray(c)&&c.length>0){const{url:d,urlWebp:o}=c[0];let p=`
