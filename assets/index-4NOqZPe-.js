import{a as u,H as T}from"./header-Eu9nKmC_.js";import{H as q,C as x,a as W,W as C,S as k}from"./swiper-tFhN8Muw.js";import{g as _,a as h,c as m,q as w,w as v}from"./index.esm2017-rngiDz6t.js";const g=document.querySelector(".main-company__swiper-wrapper");class H{app;db;productsArray;constructor(){this.app=u,this.db=_(this.app),this.productsArray=[]}async loadCards(){(await h(m(this.db,"hotels"))).forEach(a=>{const s=a.data();this.productsArray.push(s)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(a=>{const s=a,{name:e,price:r,img:c,date:i}=s;if(c&&Array.isArray(c)&&c.length>0){const{url:d,urlWebp:o}=c[0];let p=`
