import{c as D,_ as Ee,d as ke,e as Ue,f as ve,C as Le,r as W,h as Oe,S as Ie,F as Se,a as Pe,g as C,o as oe,H as Ne}from"./header-wf8HbVZh.js";import{g as Ce,b as X,c as K,d as De,u as xe}from"./index.esm2017-CVpEnNBY.js";import{a as Be}from"./justValidate-ywqcVI2V.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(t,e,n){let s=1,r=null,o=null,i=!1,a=0;function c(){return a===2}let u=!1;function l(..._){u||(u=!0,e.apply(null,_))}function p(_){r=setTimeout(()=>{r=null,t(T,c())},_)}function f(){o&&clearTimeout(o)}function T(_,...U){if(u){f();return}if(_){f(),l.call(null,_,...U);return}if(c()||i){f(),l.call(null,_,...U);return}s<64&&(s*=2);let w;a===1?(a=2,w=0):w=(s+Math.random())*1e3,p(w)}let b=!1;function E(_){b||(b=!0,f(),!u&&(r!==null?(_||(a=2),clearTimeout(r),p(0)):_||(a=1)))}return p(0),o=setTimeout(()=>{i=!0,E(!0)},n),E}function nt(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
