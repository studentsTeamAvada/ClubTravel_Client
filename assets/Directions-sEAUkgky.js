import"./jquery-DgZYk2H_.js";import{H as u}from"./header-ARewE4Ia.js";import{g as m,b as h,c as v}from"./index.esm2017-rx8I47mm.js";import{a as f}from"./firebase-IW9Y5CYr.js";import{P as g}from"./preloader-995_IHTn.js";import{I as y}from"./isAuthorization-0V39ZNC-.js";import"./index.esm2017-NEpo2ibe.js";import"./index-e24386e7-jS-Ti_7U.js";const a=document.querySelector(".directions__wrapper");class w{app;db;productsArray;constructor(){this.app=f,this.db=m(this.app),this.productsArray=[]}async loadCards(){(await h(v(this.db,"hotels"))).forEach(c=>{const t=c.data();this.productsArray.push(t)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(c=>{const t=c,{img:r,country:n,region:e,price:p,work:i}=t;if(r&&Array.isArray(r)&&r.length>0){const{url:l,urlWebp:_}=r[0];let s=`
