import{a as y,H as u}from"./header-Z2glgHCi.js";import{g as h,b as _,c as v}from"./index.esm2017-VUyrWc--.js";const n=document.querySelector(".company-company__wrapper");class g{app;db;productsArray;constructor(){this.app=y,this.db=h(this.app),this.productsArray=[]}async loadCards(){(await _(v(this.db,"hotels"))).forEach(c=>{const a=c.data();a.id=c.id,this.productsArray.push(a)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(c=>{const a=c,{name:r,price:e,img:t,date:p,id:i}=a;if(t&&Array.isArray(t)&&t.length>0){const{url:m,urlWebp:l}=t[0];let s=`
