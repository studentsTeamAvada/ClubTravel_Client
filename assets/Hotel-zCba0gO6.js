import{$ as o}from"./jquery-eLIhC4UN.js";import{H as D}from"./header-4uj2AVG8.js";import{F as S}from"./footer-RPwhMWUh.js";import{a as g}from"./firebase-IW9Y5CYr.js";import{g as v,b as k,c as x,d as f,e as $,u as L,f as q,s as E}from"./index.esm2017-rx8I47mm.js";import{b as C,c as A}from"./swiper-6MPslvsj.js";import{P as j}from"./preloader-hw-o7nAZ.js";import{o as H,g as O}from"./index-e24386e7-jS-Ti_7U.js";import"./index.esm2017-NEpo2ibe.js";import{I as P}from"./isAuthorization-0V39ZNC-.js";import"./autoplay-3nwb4p1k.js";class I{dropDown;dropMain;quatityAdults;quatityKids;addBtn;btn;children;tegContainer;error;currentAbdul;currentKids;customEvent;constructor(t){this.dropDown=o(t).find(".dropdown"),this.dropMain=this.dropDown.find(".dropdown__main"),this.quatityAdults=this.dropDown.find("#adults-quantity"),this.quatityKids=this.dropDown.find("#kids-quantity"),this.addBtn=this.dropDown.find(".dropdown__button-add"),this.error=this.dropDown.find(".dropdown__error"),this.btn=this.dropDown.find(".dropdown__btn"),this.children=this.dropDown.find(".dropdown__children"),this.tegContainer=o(".tour__quantity-tegs"),this.customEvent=new CustomEvent("myCustomEvent"),this.currentAbdul=1,this.currentKids=0,this.init()}init(){this.open(),this.counter(this.dropDown.find(".dropdown__count-one")),this.counter(this.dropDown.find(".dropdown__count-two"),!0),this.removeTag(),this.removeAgeSelect(1),this.addPeople()}open(){this.btn.on("click",()=>{this.dropDown.toggleClass("dropdown_active")});const t=this;o(document).on("click",function(r){t.dropDown.has(r.target).length==0&&t.dropDown.removeClass("dropdown_active")})}counter(t,r=!1){const e=t.find(".dropdown__count-add"),s=t.find(".dropdown__count-remove"),i=t.find(".dropdown__count-current"),n=this;function l(){let c=+i.text();if(c<9){const d=c+1;i.html(String(d)),r?n.timeout(d,1):n.currentAbdul=d}}function a(){let c=+i.text();if(c>1){const d=c-1;i.html(String(d)),r?(n.timeout(d,2),o(".dropdown__error").removeClass("dropdown__error_active-kids")):n.currentAbdul=d}}e.on("click",l),s.on("click",a)}addAgeSelect(t,r=!1){const s=this.dropDown.find(".children__drop").length;if(console.log(s),r){const i=this.kids();console.log(i),this.children.html("");let n=0;for(const l in i)for(let a=0;a<+i[l];a++){this.children.append(`
