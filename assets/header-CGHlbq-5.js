 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=new Map,_r=new Map;function lc(i,e){try{i.container.addComponent(e)}catch(r){ot.debug(`Component ${e.name} failed to register with FirebaseApp ${i.name}`,r)}}function zt(i){const e=i.name;if(_r.has(e))return ot.debug(`There were multiple attempts to register component ${e}.`),!1;_r.set(e,i);for(const r of Cn.values())lc(r,i);return!0}function rs(i,e){const r=i.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),i.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},Ke=new Yt("app","Firebase",fc);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pc="firebase-heartbeat-database",gc=1,Gt="firebase-heartbeat-store";let ur=null;function ss(){return ur||(ur=Na(pc,gc,{upgrade:(i,e)=>{switch(e){case 0:i.createObjectStore(Gt)}}}).catch(i=>{throw Ke.create("idb-open",{originalErrorMessage:i.message})})),ur}async function mc(i){try{return await(await ss()).transaction(Gt).objectStore(Gt).get(os(i))}catch(e){if(e instanceof Je)ot.warn(e.message);else{const r=Ke.create("idb-get",{originalErrorMessage:e?.message});ot.warn(r.message)}}}async function Ai(i,e){try{const a=(await ss()).transaction(Gt,"readwrite");await a.objectStore(Gt).put(e,os(i)),await a.done}catch(r){if(r instanceof Je)ot.warn(r.message);else{const a=Ke.create("idb-set",{originalErrorMessage:r?.message});ot.warn(a.message)}}}function os(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tc(i){zt(new Ct("platform-logger",e=>new Ma(e),"PRIVATE")),zt(new Ct("heartbeat",e=>new bc(e),"PRIVATE")),Tt(vr,Si,i),Tt(vr,Si,"esm2017"),Tt("fire-js","")}Tc("");var Ic="firebase",Ec="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Tt(Ic,Ec,"app");function Cr(i,e){var r={};for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&e.indexOf(a)<0&&(r[a]=i[a]);if(i!=null&&typeof Object.getOwnPropertySymbols=="function")for(var f=0,a=Object.getOwnPropertySymbols(i);f<a.length;f++)e.indexOf(a[f])<0&&Object.prototype.propertyIsEnumerable.call(i,a[f])&&(r[a[f]]=i[a[f]]);return r}function as(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Cc=as,cs=new Yt("auth","Firebase",as());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn=new es("@firebase/auth");function Sc(i,...e){Sn.logLevel<=ee.WARN&&Sn.warn(`Auth (${Zt}): ${i}`,...e)}function bn(i,...e){Sn.logLevel<=ee.ERROR&&Sn.error(`Auth (${Zt}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(e,r){this.shortDelay=e,this.longDelay=r,je(r>e,"Short delay should be less than long delay!"),this.isMobile=ia()||oa()}get(){return Rc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pc(i,e){return lt(i,"POST","/v1/accounts:delete",e)}async function Lc(i,e){return lt(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kt(i,e,r=!1){if(r)return e;try{return await e}catch(a){throw a instanceof Je&&jc(a)&&i.auth.currentUser===i&&await i.auth.signOut(),a}}function jc({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ts(i,e=[]){let r;switch(i){case"Browser":r=Ni(ae());break;case"Worker":r=`${Ni(ae())}-${i}`;break;default:r=i}const a=e.length?e.join(","):"FirebaseCore-web";return`${r}/JsCore/${Zt}/${a}`}async function Is(i,e){return lt(i,"GET","/v2/recaptchaConfig",ut(i,e))}function Pi(i){return i!==void 0&&i.enterprise!==void 0}class Es{constructor(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(r=>r.provider==="EMAIL_PASSWORD_PROVIDER"&&r.enforcementState!=="OFF")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fr(i,e){return tn(i,"POST","/v1/accounts:signInWithPassword",ut(i,e))}async function ou(i,e){return lt(i,"POST","/v1/accounts:sendOobCode",ut(i,e))}async function dr(i,e){return ou(i,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function au(i,e){return tn(i,"POST","/v1/accounts:signInWithEmailLink",ut(i,e))}async function cu(i,e){return tn(i,"POST","/v1/accounts:signInWithEmailLink",ut(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uu="http://localhost";class at extends xr{constructor(){super(...arguments),this.pendingToken=null}static _fromParams(e){const r=new at(e.providerId,e.signInMethod);return e.idToken||e.accessToken?(e.idToken&&(r.idToken=e.idToken),e.accessToken&&(r.accessToken=e.accessToken),e.nonce&&!e.pendingToken&&(r.nonce=e.nonce),e.pendingToken&&(r.pendingToken=e.pendingToken)):e.oauthToken&&e.oauthTokenSecret?(r.accessToken=e.oauthToken,r.secret=e.oauthTokenSecret):me("argument-error"),r}toJSON(){return{idToken:this.idToken,accessToken:this.accessToken,secret:this.secret,nonce:this.nonce,pendingToken:this.pendingToken,providerId:this.providerId,signInMethod:this.signInMethod}}static fromJSON(e){const r=typeof e=="string"?JSON.parse(e):e,{providerId:a,signInMethod:f}=r,h=Cr(r,["providerId","signInMethod"]);if(!a||!f)return null;const v=new at(a,f);return v.idToken=h.idToken||void 0,v.accessToken=h.accessToken||void 0,v.secret=h.secret,v.nonce=h.nonce,v.pendingToken=h.pendingToken||null,v}_getIdTokenResponse(e){const r=this.buildRequest();return Et(e,r)}_linkToIdToken(e,r){const a=this.buildRequest();return a.idToken=r,Et(e,a)}_getReauthenticationResolver(e){const r=this.buildRequest();return r.autoCreate=!1,Et(e,r)}buildRequest(){const e={requestUri:uu,returnSecureToken:!0};if(this.pendingToken)e.pendingToken=this.pendingToken;else{const r={};this.idToken&&(r.id_token=this.idToken),this.accessToken&&(r.access_token=this.accessToken),this.secret&&(r.oauth_token_secret=this.secret),r.providerId=this.providerId,this.nonce&&!this.pendingToken&&(r.nonce=this.nonce),e.postBody=Qt(r)}return e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn extends Or{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hr(i,e){return tn(i,"POST","/v1/accounts:signUp",ut(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,r,a,f=!1){const h=await st._fromIdTokenResponse(e,a,f),v=Ui(a);return new ct({user:h,providerId:v,_tokenResponse:a,operationType:r})}static async _forOperation(e,r,a){await e._updateTokensIfNecessary(a,!0);const f=Ui(a);return new ct({user:e,providerId:f,_tokenResponse:a,operationType:r})}}function Ui(i){return i.providerId?i.providerId:"phoneNumber"in i?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kn extends Je{constructor(e,r,a,f){var h;super(r.code,r.message),this.operationType=a,this.user=f,Object.setPrototypeOf(this,kn.prototype),this.customData={appName:e.name,tenantId:(h=e.tenantId)!==null&&h!==void 0?h:void 0,_serverResponse:r.customData._serverResponse,operationType:a}}static _fromErrorAndOperation(e,r,a,f){return new kn(e,r,a,f)}}function ks(i,e,r,a){return(e==="reauthenticate"?r._getReauthenticationResolver(i):r._getIdTokenResponse(i)).catch(h=>{throw h.code==="auth/multi-factor-auth-required"?kn._fromErrorAndOperation(i,h,e,a):h})}async function du(i,e,r=!1){const a=await Kt(i,e._linkToIdToken(i.auth,await i.getIdToken()),r);return ct._forOperation(i,"link",a)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hu(i,e,r=!1){const{auth:a}=i,f="reauthenticate";try{const h=await Kt(i,ks(a,f,e,i),r);M(h.idToken,a,"internal-error");const v=kr(h.idToken);M(v,a,"internal-error");const{sub:S}=v;return M(i.uid===S,a,"user-mismatch"),ct._forOperation(i,f,h)}catch(h){throw h?.code==="auth/user-not-found"&&me(a,"user-mismatch"),h}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rs(i,e,r=!1){const a="signIn",f=await ks(i,a,e),h=await ct._fromIdTokenResponse(i,a,f);return r||await i._updateCurrentUser(h.user),h}async function pu(i,e){return Rs(Ye(i),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nl(i,e,r){var a;const f=Ye(i),h={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};if(!((a=f._getRecaptchaConfig())===null||a===void 0)&&a.emailPasswordEnabled){const v=await St(f,h,"getOobCode",!0);r&&pr(f,v,r),await dr(f,v)}else r&&pr(f,h,r),await dr(f,h).catch(async v=>{if(v.code==="auth/missing-recaptcha-token"){console.log("Password resets are protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the password reset flow.");const S=await St(f,h,"getOobCode",!0);r&&pr(f,S,r),await dr(f,S)}else return Promise.reject(v)})}async function Pl(i,e,r){var a;const f=Ye(i),h={returnSecureToken:!0,email:e,password:r,clientType:"CLIENT_TYPE_WEB"};let v;if(!((a=f._getRecaptchaConfig())===null||a===void 0)&&a.emailPasswordEnabled){const x=await St(f,h,"signUpPassword");v=hr(f,x)}else v=hr(f,h).catch(async x=>{if(x.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const q=await St(f,h,"signUpPassword");return hr(f,q)}else return Promise.reject(x)});const S=await v.catch(x=>Promise.reject(x)),A=await ct._fromIdTokenResponse(f,"signIn",S);return await f._updateCurrentUser(A.user),A}function Ll(i,e,r){return pu(Xe(i),At.credential(e,r))}function gu(i,e,r,a){return Xe(i).onIdTokenChanged(e,r,a)}function mu(i,e,r){return Xe(i).beforeAuthStateChanged(e,r)}function yu(i,e,r,a){return Xe(i).onAuthStateChanged(e,r,a)}const Rn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ku(i,e={}){return lt(i,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nl=new en(5e3,15e3),rl="__/auth/iframe",il="emulator/auth/iframe",sl={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},ol=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function al(i){const e=i.config;M(e.authDomain,i,"auth-domain-config-required");const r=e.emulator?Ar(e,il):`https://${i.config.authDomain}/${rl}`,a={apiKey:e.apiKey,appName:i.name,v:Zt},f=ol.get(i.config.apiHost);f&&(a.eid=f);const h=i._getFrameworks();return h.length&&(a.fw=h.join(",")),`${r}?${Qt(a).slice(1)}`}async function cl(i){const e=await tl(i),r=Re().gapi;return M(r,i,"internal-error"),e.open({where:document.body,url:al(i),messageHandlersFilter:r.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:sl,dontclear:!0},a=>new Promise(async(f,h)=>{await a.restyle({setHideOnLeave:!1});const v=ke(i,"network-request-failed"),S=Re().setTimeout(()=>{h(v)},nl.get());function A(){Re().clearTimeout(S),f(a)}a.ping(A).then(A,()=>{h(v)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ml="__/auth/handler",yl="emulator/auth/handler",vl=encodeURIComponent("fac");async function Wi(i,e,r,a,f,h){M(i.config.authDomain,i,"auth-domain-config-required"),M(i.config.apiKey,i,"invalid-api-key");const v={apiKey:i.config.apiKey,appName:i.name,authType:r,redirectUrl:a,v:Zt,eventId:f};if(e instanceof Or){e.setDefaultLanguage(i.languageCode),v.providerId=e.providerId||"",ha(e.getCustomParameters())||(v.customParameters=JSON.stringify(e.getCustomParameters()));for(const[q,X]of Object.entries(h||{}))v[q]=X}if(e instanceof nn){const q=e.getScopes().filter(X=>X!=="");q.length>0&&(v.scopes=q.join(","))}i.tenantId&&(v.tid=i.tenantId);const S=v;for(const q of Object.keys(S))S[q]===void 0&&delete S[q];const A=await i._getAppCheckToken(),x=A?`#${vl}=${encodeURIComponent(A)}`:"";return`${bl(i)}?${Qt(S).slice(1)}${x}`}function bl({config:i}){return i.emulator?Ar(i,yl):`https://${i.authDomain}/${ml}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Il(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function El(i){zt(new Ct("auth",(e,{options:r})=>{const a=e.getProvider("app").getImmediate(),f=e.getProvider("heartbeat"),h=e.getProvider("app-check-internal"),{apiKey:v,authDomain:S}=a.options;M(v&&!v.includes(":"),"invalid-api-key",{appName:a.name});const A={apiKey:v,authDomain:S,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ts(i)},x=new Zc(a,f,h,A);return tu(x,r),x},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,r,a)=>{e.getProvider("auth-internal").initialize()})),zt(new Ct("auth-internal",e=>{const r=Ye(e.getProvider("auth").getImmediate());return(a=>new Tl(a))(r)},"PRIVATE").setInstantiationMode("EXPLICIT")),Tt(qi,Vi,Il(i)),Tt(qi,Vi,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cl=5*60,Sl=Zi("authIdTokenMaxAge")||Cl;let zi=null;const Al=i=>async e=>{const r=e&&await e.getIdTokenResult(),a=r&&(new Date().getTime()-Date.parse(r.issuedAtTime))/1e3;if(a&&a>Sl)return;const f=r?.token;zi!==f&&(zi=f,await fetch(i,{method:f?"POST":"DELETE",headers:f?{Authorization:`Bearer ${f}`}:{}}))};function kl(i=hc()){const e=rs(i,"auth");if(e.isInitialized())return e.getImmediate();const r=eu(i,{popupRedirectResolver:wl,persistence:[Nu,wu,Ns]}),a=Zi("authTokenSyncURL");if(a){const h=Al(a);mu(r,h,()=>h(r.currentUser)),gu(r,v=>h(v))}const f=Yi("auth");return f&&nu(r,`http://${f}`),r}El("Browser");const Rl={apiKey:"AIzaSyAVwhQr2zeNEAr1FSrD6ygo5dJeLkxjtRk",authDomain:"clubtravel-6eff6.firebaseapp.com",projectId:"clubtravel-6eff6",storageBucket:"clubtravel-6eff6.appspot.com",messagingSenderId:"883499742498",appId:"1:883499742498:web:b0bf6b06d8073d249a217b"},Ul=is(Rl);class xl{promise(){return new Promise(e=>{yu(kl(),r=>{e(r||!1)})})}}class jl{burgerBtn;body;constructor(){this.burgerBtn=yn(".menu__icon"),this.body=yn("body"),this.init()}init(){this.burger(),this.scroll(),this.getSing(),this.resize()}burger(){const e=this;this.burgerBtn.on("click",function(){e.body.toggleClass("burger-active")})}scroll(){window.addEventListener("scroll",()=>{window.scrollY>70||window.pageYOffset>70?this.body.addClass("scroll"):this.body.removeClass("scroll")})}resize(){const e=this;function r(){navigator.maxTouchPoints?e.body.addClass("touch-screen"):e.body.removeClass("touch-screen")}r(),window.addEventListener("resize",r)}async getSing(){const e=await new xl().promise(),r=yn(".top-list__link-user"),a=yn(".menu__user-mobile-link");e?(r.html('<svg id="icon-account"><use xlink:href="#user"></use></svg>'),r.removeClass("top-list__not-sing"),r.attr("href","Account.html"),a.attr("href","Account.html"),a.html('<svg id="icon-account"><use xlink:href="#user"></use></svg>'),console.log("Пользователь авторизирован")):(r.html('<svg id="icon-account"><use xlink:href="#sing"></use></svg>'),r.addClass("top-list__not-sing"),r.attr("href","authorization.html"),a.attr("href","authorization.html"),a.html('<svg id="icon-account"><use xlink:href="#sing"></use></svg>'),console.log("Пользователь авторизирован"))}}export{yn as $,Ct as C,We as F,qe as G,jl as H,ee as L,Zt as S,zt as _,Ul as a,Ml as b,xl as c,Go as d,Ko as e,Nl as f,kl as g,Pl as h,Je as i,Jo as j,Xe as k,hc as l,rs as m,Dl as n,yu as o,es as p,Ol as q,Tt as r,Ll as s};
