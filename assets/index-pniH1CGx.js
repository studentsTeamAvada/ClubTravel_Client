import{H as T}from"./header-o5Nvgfqe.js";import{h as $,c as q,a as x,w as k,s as P}from"./swiper-CIf3Z10M.js";import{a as n}from"./firebase-bdvRN3Io.js";import{g as l,a as u,c as _,q as m,w}from"./index.esm2017-6EBzZu0o.js";import"./index.esm-f6w6U5a0.js";const y=document.querySelector(".main-company__swiper-wrapper");class W{app;db;productsArray;constructor(){this.app=n,this.db=l(this.app),this.productsArray=[]}async loadCards(){(await u(_(this.db,"hotels"))).forEach(e=>{const r=e.data();this.productsArray.push(r)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const r=e,{name:a,price:s,img:c}=r;if(c&&Array.isArray(c)&&c.length>0){const{url:p,urlWebp:i}=c[0];let o=`
      <div class="swiper-slide main-company__swiper-slide">
        ...
        `,y&&y.insertAdjacentHTML("beforeend",o)}})}}const g=document.querySelector(".hot-deals__swiper-wrapper");class C{app;db;productsArray;constructor(){this.app=n,this.db=l(this.app),this.productsArray=[]}async loadCards(){const t=m(_(this.db,"hotels"),w("hotTour","==",!0));(await u(t)).forEach(r=>{const a=r.data();this.productsArray.push(a)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const r=e,{name:a,price:s,country:c,region:p,star:i,img:o}=r;if(o&&Array.isArray(o)&&o.length>0){const{url:A,urlWebp:S}=o[0];let d=`
      <div class="swiper-slide hot-deals__swiper-slide">
        ...
        `,g&&g.insertAdjacentHTML("beforeend",d)}})}}const f=document.querySelector(".winter-tour__swiper-wrapper");class H{app;db;productsArray;constructor(){this.app=n,this.db=l(this.app),this.productsArray=[]}async loadCards(){const t=m(_(this.db,"hotels"),w("hotTour","==",!0));(await u(t)).forEach(r=>{const a=r.data();this.productsArray.push(a)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const r=e,{country:a,img:s}=r;if(s&&Array.isArray(s)&&s.length>0){const{url:c,urlWebp:p}=s[0];let i=`
      ...
      <div class="swiper-slide summer-tour__swiper-slide">
        ...
        `;b&&b.insertAdjacentHTML("beforeend",i)}})}}new T;const D=new W,j=new C,L=new H,M=new E;$();q();x();k();P();await D.loadCards();await j.loadCards();await L.loadCards();await M.loadCards();
