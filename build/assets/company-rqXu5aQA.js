<<<<<<<< HEAD:build/assets/company-EdwxkcRF.js
import{H as m}from"./header-9Fuft6xP.js";import{g as l,a as y,c as u}from"./index.esm2017-9WYfP4j3.js";import{i as f}from"./index.esm-RQMDg1fI.js";const g={apiKey:"AIzaSyAVwhQr2zeNEAr1FSrD6ygo5dJeLkxjtRk",authDomain:"clubtravel-6eff6.firebaseapp.com",projectId:"clubtravel-6eff6",storageBucket:"clubtravel-6eff6.appspot.com",messagingSenderId:"883499742498",appId:"1:883499742498:web:b0bf6b06d8073d249a217b"},o=document.querySelector(".company-company__wrapper");class h{app;db;productsArray;constructor(){this.app=f(g),this.db=l(this.app),this.productsArray=[]}async loadCards(){(await y(u(this.db,"hotels"))).forEach(c=>{const r=c.data();this.productsArray.push(r)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(c=>{const r=c,{name:t,price:e,img:a,date:n}=r;if(a&&Array.isArray(a)&&a.length>0){const{url:i,urlWebp:d}=a[0];let s=`
========
...
>>>>>>>> 667309d8f251983cc7dd0db29ac6e881384a0f61:build/assets/company-rqXu5aQA.js
