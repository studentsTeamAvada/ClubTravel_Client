import"./jquery-eLIhC4UN.js";import{H as T}from"./header-4uj2AVG8.js";import{H as q,C as x,a as P,W,S as C}from"./swiper-G_k_SzQb.js";import{a as l}from"./firebase-WXR3vcUU.js";import{g as m,a as _,c as h,q as w,w as v}from"./index.esm2017-LJKvdAav.js";import{P as k}from"./preloader-hw-o7nAZ.js";import"./autoplay-3nwb4p1k.js";import"./index.esm-RQMDg1fI.js";const g=document.querySelector(".main-company__swiper-wrapper");class H{app;db;productsArray;constructor(){this.app=l,this.db=m(this.app),this.productsArray=[]}async loadCards(){(await _(h(this.db,"hotels"))).forEach(a=>{const s=a.data();this.productsArray.push(s)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(a=>{const s=a,{name:e,price:r,img:c,date:i}=s;if(c&&Array.isArray(c)&&c.length>0){const{url:p,urlWebp:o}=c[0];let n=`
