import{H as T}from"./header-9Fuft6xP.js";import{H as $,C as q,a as x,W,S as k}from"./swiper-8s-Bbwav.js";import{a as n}from"./firebase-WXR3vcUU.js";import{g as l,a as u,c as _,q as m,w}from"./index.esm2017-9WYfP4j3.js";import"./index.esm-RQMDg1fI.js";const y=document.querySelector(".main-company__swiper-wrapper");class C{app;db;productsArray;constructor(){this.app=n,this.db=l(this.app),this.productsArray=[]}async loadCards(){(await u(_(this.db,"hotels"))).forEach(e=>{const r=e.data();this.productsArray.push(r)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const r=e,{name:a,price:s,img:c}=r;if(c&&Array.isArray(c)&&c.length>0){const{url:p,urlWebp:i}=c[0];let o=`
