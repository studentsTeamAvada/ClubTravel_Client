import"./jquery-eLIhC4UN.js";import{H as _}from"./header-4uj2AVG8.js";import{g as f,a as m,c as h}from"./index.esm2017-LJKvdAav.js";import{i as b}from"./index.esm-RQMDg1fI.js";import{P as g}from"./preloader-hw-o7nAZ.js";const v={apiKey:"AIzaSyAVwhQr2zeNEAr1FSrD6ygo5dJeLkxjtRk",authDomain:"clubtravel-6eff6.firebaseapp.com",projectId:"clubtravel-6eff6",storageBucket:"clubtravel-6eff6.appspot.com",messagingSenderId:"883499742498",appId:"1:883499742498:web:b0bf6b06d8073d249a217b"},i=document.querySelector(".directions__wrapper");class y{app;db;productsArray;constructor(){this.app=b(v),this.db=f(this.app),this.productsArray=[]}async loadCards(){(await m(h(this.db,"hotels"))).forEach(e=>{const c=e.data();this.productsArray.push(c)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(e=>{const c=e,{img:r,country:n,region:a,price:p,work:t}=c;if(r&&Array.isArray(r)&&r.length>0){const{url:l,urlWebp:u}=r[0];let s=`
