import{H as k}from"./header-o5Nvgfqe.js";import{h as $,c as x,a as T,w as I,s as q}from"./swiper-CIf3Z10M.js";import{g as n,a as l,c as u,q as _,w as f}from"./index.esm2017-6EBzZu0o.js";import{i as m}from"./index.esm-f6w6U5a0.js";const C={apiKey:"AIzaSyAVwhQr2zeNEAr1FSrD6ygo5dJeLkxjtRk",authDomain:"clubtravel-6eff6.firebaseapp.com",projectId:"clubtravel-6eff6",storageBucket:"clubtravel-6eff6.appspot.com",messagingSenderId:"883499742498",appId:"1:883499742498:web:b0bf6b06d8073d249a217b"},w=document.querySelector(".main-company__swiper-wrapper");class D{app;db;productsArray;constructor(){this.app=m(C),this.db=n(this.app),this.productsArray=[]}async loadCards(){(await l(u(this.db,"hotels"))).forEach(a=>{const r=a.data();this.productsArray.push(r)}),this.renderProducts()}renderProducts(){this.productsArray.forEach(a=>{const r=a,{name:e,price:s,img:c}=r;if(c&&Array.isArray(c)&&c.length>0){const{url:p,urlWebp:i}=c[0];let o=`
