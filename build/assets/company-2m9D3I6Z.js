<<<<<<< HEAD:build/assets/company-2m9D3I6Z.js
...
import { H as d } from "./header-qNeuh3vS.js";
import { i as m, g as l, a as y, c as u } from "./index.esm-T2_TDg20.js";
const f = {
  ...
  o = document.querySelector(".company-company__wrapper");
class g {
  app;
  db;
  productsArray;
  constructor() {
    (this.app = m(f)), (this.db = l(this.app)), (this.productsArray = []);
  }
  async loadCards() {
    (await y(u(this.db, "hotels"))).forEach((c) => {
      const r = c.data();
  ...
  renderProducts() {
    this.productsArray.forEach((c) => {
      const r = c,
        { name: t, price: e, img: a } = r;
      if (a && Array.isArray(a) && a.length > 0) {
        const { url: n, urlWebp: i } = a[0];
        let s = `
>>>>>>> 256605da1f8988e3449cc2efacc4e58c4294350b:build/assets/company.html-S7h7p50f.js
        ...
        `),
          o && o.insertAdjacentHTML("beforeend", s);
      }
    });
  }
}
