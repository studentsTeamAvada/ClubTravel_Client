import"./modulepreload-polyfill-9p4a8sJU.js";import{H as w}from"./header-msV6j5kN.js";import{h as f,c as y,a as b}from"./swiper-Dbzzl9DU.js";import"./autoplay-3nwb4p1k.js";async function P(){const a=document.querySelector(".company__swiper-wrapper");(async()=>{(await(await fetch("http://localhost:1337/api/tours?populate=deep")).json()).data.forEach(i=>{const p=i.attributes,{title:d,data:l,price:t,img:n,webP:u}=p;let c=null,r=null;n.data.forEach(e=>{c=e.attributes.url}),u.data.forEach(e=>{r=e.attributes.url});let s=`
      <div class="swiper-slide company__swiper-slide">
        ...
        <div class="company__card-img">
          ...
          <div class="company__card-data-wrapper">
            ...
            <p class="company__card-data">${l}</p>
          </div>
        </div>
        <p class="company__card-text">${d}</p>
      </div>
      </div>
        `,a&&a.insertAdjacentHTML("beforeend",s)})})()}async function $(){const a=document.querySelector(".hot-deals__swiper-wrapper");(async()=>{const o=await(await fetch("http://localhost:1337/api/hot-dealses?populate=deep")).json();console.log(o),o.data.forEach(i=>{const p=i.attributes,{title:d,data:l,price:t,img:n,webP:u}=p;let c=null,r=null;n.data.forEach(e=>{c=e.attributes.url}),u.data.forEach(e=>{r=e.attributes.url});let s=`
      <div class="swiper-slide hot-deals__swiper-slide">
        ...
        <div class="hot-deals__card-img">
          ...
          <div class="hot-deals__card-data-wrapper">
            ...
            <p class="hot-deals__card-data">${l}</p>
          </div>
        </div>
        <div class="hot-deals__card-text-wrapper">
            <p class="hot-deals__card-text">${d}</p>
        ...
        `,a&&a.insertAdjacentHTML("beforeend",s)})})()}document.addEventListener("DOMContentLoaded",async()=>{new w,f(),y(),b(),await P(),await $()});
